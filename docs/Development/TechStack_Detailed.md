...
|------|-----------------|------|----------------------|
| **Paper** | 1.20.2+ | メイン/PG用ゲームサーバーエンジン。高い安定性とプラグイン互換性。 | [PaperMC](https://papermc.io/) |
...
|-----------|------|-----------------|-------------|
| **Skript** | メインの開発環境。ほぼ全てのゲームロジックを記述。 | なし | [Skript GitHub](https://github.com/SkriptLang/Skript) |
...
*   **Paper API Docs**: [https://jd.papermc.io/paper/1.20/](https://jd.papermc.io/paper/1.20/) (reflect使用時の参照)
